...
import { circles, circles2, lines, lines2, circles3, particles, particles2, particles3, circles4, circles5, lines3, particles4, particles5, lines4, lines5 } from "./art";

const artgen = <HTMLDivElement> document.getElementById("artgen");

let drawEngine = new DrawEngine(lines5, artgen);
