import { Lambda, generate, Shape, updateShapes, unwrap, rgba, DecoratedPoint } from "../types";

const particlesGen7 = (): Lambda => {
    ...
    const lambda: Lambda = (x: number) => {
        ...
        let residualParticles = baseParticles.reduce((accum, point) => {
            ...
            accum.push({
                ...
                radius: unwrap([Math.min(x / 200, 2), Math.min(x / 200, 2) + 2]),
