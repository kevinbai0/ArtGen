import { Lambda, generate, Shape, updateShapes, unwrap, rgba, DecoratedPoint, RGBA } from "../types";
...
const particlesGen8 = (): Lambda => {
    ...
    const lambda: Lambda = (x: number) => {
        ...
        let residualParticles = baseParticles.reduce((accum, point) => {
            const color = rgba([200,255],[150, 220],[0, 1], unwrap([0.2, 0.7])) as RGBA;
            counter += 1;
            accum.push(new AnimatedPoint({
                ...point,
                stroke: color,
